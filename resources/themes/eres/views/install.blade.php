                    ...
                    <div class="ui fluid card">
                        ...
                        <div class="content body">
                            ...
                            <div class="step general" :class="{ active: stepIsActive(2) }">
                                <div class="field">
                                    <div style="text-align:center;"><b>Developed by: CloudLinkd.com</b></div>
                                    <input id="licensekey" type="hidden" name="licensekey" value="CloudLinkd.com">
                                </div>

                                <div class="field">
                                    <div style="text-align:center;"><b>www.CloudLinkd.com</b></div>
